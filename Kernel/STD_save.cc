...
STD_save::STD_save()
{
    ...
    std::cerr << "STD_save::STD_save() finished"<<std::endl;
#endif
}

STD_save::STD_save(const STD_save& other)
        : Files(other)
{
    runNumber_ = other.runNumber_;
#ifdef DEBUG_CONSTRUCTOR
    std::cerr << "STD_save::STD_save(STD_save& other) finished"<<std::endl;
#endif
}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
int STD_save::readRunNumberFromFile()
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void STD_save::setRunNumber(int runNumber)
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
int STD_save::getRunNumber() const
{
    return runNumber_;
}
...
void STD_save::incrementRunNumberInFile()
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
std::vector<int> STD_save::get2DParametersFromRunNumber(int size_x, int size_y)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
int STD_save::launchNewRun(const char* name, bool quick UNUSED)
{
