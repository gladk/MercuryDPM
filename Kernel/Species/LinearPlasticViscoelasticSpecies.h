...
#ifndef LinearPlasticViscoelasticSpecies_H
#define LinearPlasticViscoelasticSpecies_H
...
class LinearPlasticViscoelasticSpecies : public virtual BaseSpecies
{
public:
    typedef LinearPlasticViscoelasticInteraction InteractionType;
    LinearPlasticViscoelasticSpecies();
    LinearPlasticViscoelasticSpecies(const LinearPlasticViscoelasticSpecies &p);
    virtual ~LinearPlasticViscoelasticSpecies();
    LinearPlasticViscoelasticSpecies* copy() const;
...
// Species-specific functions
    ...
    void mix(LinearPlasticViscoelasticSpecies* const S, LinearPlasticViscoelasticSpecies* const T);
