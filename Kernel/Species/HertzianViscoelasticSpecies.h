...
#ifndef HertzianViscoelasticSpecies_H
#define HertzianViscoelasticSpecies_H
...
class HertzianViscoelasticSpecies : public virtual BaseSpecies
{
public:
    typedef HertzianViscoelasticInteraction InteractionType;

    HertzianViscoelasticSpecies();
    HertzianViscoelasticSpecies(const HertzianViscoelasticSpecies &p);
    virtual ~HertzianViscoelasticSpecies();
    HertzianViscoelasticSpecies* copy() const;
...
// Species-specific functions
    ...
    void mix(HertzianViscoelasticSpecies* const SBase, HertzianViscoelasticSpecies* const TBase);
