...
class EmptyTangentialInteraction : public virtual BaseInteraction
{
public:
    typedef EmptyTangentialSpecies SpeciesType;
    EmptyTangentialInteraction(BaseInteractable* P, BaseInteractable* I, Mdouble timeStamp);
    EmptyTangentialInteraction(const EmptyTangentialInteraction &p);
    virtual ~EmptyTangentialInteraction();
    ...
    const EmptyTangentialSpecies* getSpecies() const;
