...
#include "Species/HertzianViscoelasticSpecies.h"
...
void HertzianViscoelasticInteraction::computeForce()
{
    ...
    {
        const HertzianViscoelasticSpecies* species = getSpecies();
...
const HertzianViscoelasticSpecies* HertzianViscoelasticInteraction::getSpecies() const
{
    return dynamic_cast<const HertzianViscoelasticSpecies*>(getBaseSpecies());
}
