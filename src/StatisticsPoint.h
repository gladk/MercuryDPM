...
public:
	...
	///Linear displacement, \f$1/(2 \rho_i^2) \sum_{ij} m_i m_j \phi_j (v_{ija} \partial_b \phi_i + v_{ijb} \partial_a \phi_i) \f$
	...
	///Energy flux, \f$1/2 \sum_i m_i v_{ia} v_{ia} v_{ib} \phi_i\f$
	Vec3D EnergyFlux; 
	...
	Mdouble Dissipation; 
	///Elastic energy \f$1/4 \sum_{ij} (k \delta_{ij}^2 +k^t {\delta^t_{ij}}^2) \phi_i\f$
